        ...
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <span className="italic">secure</span> systems
            </motion.h1>
            <motion.p
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          ...
          <motion.h2
            ...
            className="mb-12 text-3xl font-semibold tracking-[-0.03em] text-[#1a1a1a] md:text-5xl"
          >
            The people behind <span className="italic">Safars</span>
          </motion.h2>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {team.map((member, i) => (
              ...
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#1a1a1a] text-sm font-semibold text-white">
                  {member.initials}
                </div>
                <div>
