            ...
            >
              {submitted ? (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="group inline-flex items-center justify-center gap-2 rounded-xl border border-[var(--pine-teal)]/35 bg-[var(--color-card)] px-7 py-3.5 font-medium text-[var(--pine-teal)] opacity-100 transition-colors hover:bg-[var(--color-card-highlight)]"
                  >
                    Join waitlist
                    <ArrowUpRight
                      size={16}
