...
export function FAQ() {
  ...
  return (
    <section
      id="faq"
      className="relative overflow-hidden bg-[var(--dust-grey)] py-20 text-[var(--pine-teal)] md:py-28 lg:py-32"
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.7),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(26,26,26,0.08),transparent_28%)]" />

      <div className="container mx-auto px-6">
        <div className="relative z-10 grid gap-16 rounded-[2rem] border border-[var(--pine-teal)]/10 bg-white/70 p-6 shadow-[0_24px_70px_rgba(26,26,26,0.08)] backdrop-blur-sm lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:gap-20 lg:p-10">
          <motion.div
          ...
          <div className="space-y-14">
            {faqGroups.map((group, groupIndex) => (
              ...
              >
                ...
                <div className="rounded-2xl border border-[var(--pine-teal)]/14 bg-white/70">
                  {group.items.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-[var(--pine-teal)]/20 bg-white/60 text-[var(--pine-teal)]">
                            {isOpen ? (
                          ...
                          <span
                            role="paragraph"
                            className="faq-question pr-4 text-xl font-normal tracking-[-0.03em] text-[var(--color-text-heading)] md:text-[1.9rem] md:leading-[1.15]"
                          >
                            {item.question}
                          </span>
                        </button>
