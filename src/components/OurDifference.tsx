      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-semibold tracking-[-0.05em] text-[var(--pine-teal)] md:text-5xl lg:text-6xl lg:leading-[0.98]">
            Built for teams moving at product speed
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {differenceItems.map((item, index) => (
            <motion.article
              ...
              className={`group relative overflow-hidden rounded-[2rem] border border-[var(--pine-teal)]/10 p-8 shadow-[0_24px_70px_rgba(26,26,26,0.08)] ${item.card}`}
            >
