...
export const ServicePageTemplate = ({ service }: ServicePageTemplateProps) => {
  ...
  return (
    <main className="min-h-screen bg-[var(--dust-grey)] text-[var(--pine-teal)] selection:bg-[var(--dry-sage)] selection:text-[var(--pine-teal)]">
        ...
        <div className="container relative z-10 mx-auto flex min-h-[80vh] items-center px-6">
          <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-center pb-16 pt-32 text-center md:pt-40">
            <motion.div
              ...
              className="mb-6 inline-flex items-center gap-3 rounded-full border border-[var(--pine-teal)]/15 bg-white/80 px-5 py-2 backdrop-blur-md"
            >
            ...
            >
              <Link href="#contact">
                <Button
                  size="lg"
                  variant="dark"
                  className="px-8 text-base shadow-[0_18px_40px_rgba(26,26,26,0.16)]"
                >
                  Get started
                </Button>
              </Link>
            ...
            >
              {service.stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-[var(--pine-teal)]/10 bg-white/80 px-5 py-4 backdrop-blur-md"
                >
        ...
        <div className="container mx-auto px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="overflow-hidden rounded-[2rem] border border-[var(--pine-teal)]/8 shadow-[0_24px_70px_rgba(26,26,26,0.08)]">
                <Image
                  src={service.image}
                  alt={service.title}
                  width={640}
              ...
              <div className="absolute -left-4 -top-4 h-20 w-20 rounded-full bg-[rgba(26,26,26,0.08)] blur-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
            ...
            {service.features.map((feature, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="group relative overflow-hidden rounded-[2rem] border border-[var(--pine-teal)]/8 bg-white p-8 shadow-[0_24px_70px_rgba(26,26,26,0.04)] backdrop-blur-sm transition-all hover:border-[var(--pine-teal)]/18 hover:shadow-[0_24px_70px_rgba(26,26,26,0.10)]"
                >
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <div className="space-y-8 md:space-y-12">
              {service.process.map((step, index) => (
                ...
                >
                  {/* Step number */}
                  <div className="relative z-10 flex h-16 w-16 shrink-0 items-center justify-center rounded-full border-2 border-[var(--pine-teal)]/25 bg-white text-xl font-semibold text-[var(--pine-teal)]">
                    {String(step.step).padStart(2, "0")}
                  </div>

                  {/* Content */}
                  <div className="flex-1 rounded-[1.5rem] border border-[var(--pine-teal)]/8 bg-white p-6 shadow-[0_12px_40px_rgba(26,26,26,0.04)] md:p-8">
      ...
      >
        {/* Subtle grid */}
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(26,26,26,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(26,26,26,0.03)_1px,transparent_1px)] bg-[size:40px_40px] opacity-40" />
        <div className="container relative z-10 mx-auto px-6">
          <div className="mx-auto max-w-3xl text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-full border border-[var(--pine-teal)]/12 bg-white backdrop-blur-md">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <Link href="/#contact">
                  <Button
                    size="lg"
                    variant="dark"
                    className="px-8 text-base shadow-[0_18px_40px_rgba(26,26,26,0.12)]"
                  >
        ...
        <div className="pointer-events-none absolute left-1/4 top-1/2 h-[40%] w-[40%] -translate-y-1/2 rounded-full bg-[rgba(26,26,26,0.08)] blur-[120px]" />
      </section>
    </main>
  );
};
