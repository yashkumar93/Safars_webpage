...
const serviceTones = [
  {
    card: "bg-[#e7ebde] border-[var(--dry-sage)]/50",
    icon: "bg-[var(--dry-sage)]/25 text-[var(--pine-teal)]",
    body: "text-[var(--hunter-green)]/96",
    cta: "text-[var(--fern)]",
  },
  {
    card: "bg-[#dde6d9] border-[var(--fern)]/25",
    icon: "bg-[var(--fern)]/15 text-[var(--fern)]",
    body: "text-[var(--hunter-green)]/94",
    cta: "text-[var(--pine-teal)]",
  },
  {
    card: "bg-[#e9e5da] border-[var(--dry-sage)]/35",
    icon: "bg-[var(--dry-sage)]/22 text-[var(--hunter-green)]",
    body: "text-[var(--hunter-green)]/92",
    cta: "text-[var(--hunter-green)]",
  },
  {
    card: "bg-[#dde4dc] border-[var(--pine-teal)]/18",
    icon: "bg-[var(--pine-teal)]/12 text-[var(--pine-teal)]",
    body: "text-[var(--hunter-green)]/92",
    cta: "text-[var(--pine-teal)]",
  },
];
    ...
    <section id="services" className="bg-[var(--dust-grey)] py-16 md:py-24">
      <div className="container mx-auto px-6">
        <div className="mb-12 flex flex-wrap items-end justify-between gap-6">
          ...
          >
            One team for <span className="italic">build, secure,</span> and scale
          </motion.h2>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.article
                ...
                className={`${service.size} relative overflow-hidden rounded-[2rem] p-8 shadow-[0_24px_70px_rgba(52,78,65,0.08)] ${service.featured
                  ? "border border-[var(--pine-teal)] bg-[var(--pine-teal)] text-[#f3f1ea]"
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col justify-between">
                  <div>
                    ...
                    <h3
                      className={`mb-3 text-2xl font-semibold tracking-[-0.03em] ${service.featured ? "text-[#f3f1ea]" : "text-[var(--pine-teal)]"
                        }`}
                    >
                      {service.title}
                    </h3>
