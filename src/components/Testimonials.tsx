...
export function Testimonials() {
    ...
    return (
        <section className="relative overflow-hidden bg-[radial-gradient(circle_at_20%_15%,#466757_0%,#2f463a_46%,#1f2f27_100%)] py-20 md:py-28 lg:py-36">
                ...
                <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 backdrop-blur-sm md:p-10">
                            ...
                            >
                                ...
                                <div className="flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[var(--color-text-on-dark-muted)]/86 text-xs tracking-[0.15em] uppercase font-medium">
                                            {current.title}
                                        </p>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                onClick={handlePrev}
                                className="group w-12 h-12 flex items-center justify-center rounded-full border border-white/20 text-[var(--color-text-on-dark-muted)]/90 hover:border-[var(--dry-sage)]/65 hover:text-[var(--dry-sage)] transition-all duration-300"
